...
type
  ...
  published
    ...
    property senhaDupla : string read FSenhaDupla write FSenhaDupla;
  end;

  TClassVisual = class(TJsonDTO)
  private
...
constructor TClassVisual.Create;
begin
  inherited;
  FConfiguracoes := TDisplay.Create;
end;

destructor TClassVisual.Destroy;
begin
  FConfiguracoes.Free;
inherited;
end;
